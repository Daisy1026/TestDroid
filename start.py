...
def parse_args():
    ...
    """
    parser = argparse.ArgumentParser(description="Start TestDroid to detect setting issues.",
    ...
    parser.add_argument("-pro_back", action="store", dest="pro_back", required=False,
                        help="The percentage of click event", default=3)
    ...
    parser.add_argument("-rest_interval", action="store", dest="rest_interval", required=False, default=2, type=int,
                        help="time to sleep")
...
def main():
    ...
    if len(opts.strategy_list) + \
            1 != len(opts.append_device) and opts.serial_or_parallel == 1:
