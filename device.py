...
class Device(object):
    ...
    def restart(self,emulator_path,emulator_name):
        ...
        print("restart--time.sleep(self.rest_interval*20)")
        ...
        print("restart--time.sleep(self.rest_interval*10)")
    ...
    def make_strategy_runcount(self,run_count,root_path):
        self.path=root_path+"strategy4451-1_"+self.strategy+"/"+str(run_count)+"/"
